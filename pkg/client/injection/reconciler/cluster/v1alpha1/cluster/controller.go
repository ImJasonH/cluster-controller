...
import (
	...
	versionedscheme "github.com/imjasonh/cluster-controller/pkg/client/clientset/versioned/scheme"
	client "github.com/imjasonh/cluster-controller/pkg/client/injection/client"
	cluster "github.com/imjasonh/cluster-controller/pkg/client/injection/informers/cluster/v1alpha1/cluster"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "cluster-controller"
	defaultFinalizerName       = "clusters.cluster.example.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	clusterInformer := cluster.Get(ctx)
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "cluster.example.dev.Cluster"),
	)
